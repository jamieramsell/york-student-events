...
public class Cohort implements ICohort {
     ...
     * <li>Placement years are represented by a year of 3; third years are represented by 4.
     * Note that this means that any students who are not following a placement year
     * route seemingly jump straight from year 2 into year 4.</li>
    ...
    public String toString() {
        return String.format("Cohort[id=%s, name='%s', department='%s', academicYear=%d, yearGroup=%d, members=%s]", id, name, department, academicYear, yearGroup, members);
    }
}
